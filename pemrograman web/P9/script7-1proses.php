...
<form method="POST" action="">
    ...
    <input type="number" name="bil1" required><br><br>
    
    <label>Bilangan 2: </label>
    <input type="number" name="bil2" required><br><br>
    
    <label>Bilangan 3: </label>
    <input type="number" name="bil3" required><br><br>
    
    <input type="submit" value="Cari Maksimum">
</form>

<?php
if(isset($_POST['bil1']) && isset($_POST['bil2']) && isset($_POST['bil3'])) {
